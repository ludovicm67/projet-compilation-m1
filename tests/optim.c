...
void test_optim_add_zero(void) {
  ...
  while (read(fd[0], buff, BUFF_SIZE) > 0) {
    TEST_CHECK(!strcmp(buff,
                       ...
                       "\n"
                       "  // operations\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp1, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp1\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp1, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp1\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp3, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp3\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp3, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp3\n"
                       "  mpc_add(c2mp_temp4, c2mp_temp3, c2mp_temp2, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp3 + c2mp_temp2\n"
                       "\n"
...
void test_optim_mul_one(void) {
  ...
  while (read(fd[0], buff, BUFF_SIZE) > 0) {
    TEST_CHECK(!strcmp(buff,
                       ...
                       "\n"
                       "  // operations\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp0, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp0\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp0, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp0\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp3, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp3\n"
                       "  mpc_set(c2mp_temp4, c2mp_temp3, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp3\n"
                       "  mpc_mul(c2mp_temp4, c2mp_temp3, c2mp_temp2, MPC_RNDZZ); // c2mp_temp4 = c2mp_temp3 * c2mp_temp2\n"
                       "\n"
                       "  // free memory of all variables that we used\n"
                       "  mpc_clear(c2mp_temp0);\n"
                       "  mpc_clear(c2mp_temp1);\n"
