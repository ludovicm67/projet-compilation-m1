...
int main() {
  ...
  mpfr_set_d(c2mp_temp9, 2.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp10, 2.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp14, 8.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp19, 2.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp20, 4.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp24, 3.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp25, 4.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp27, pc, MPFR_RNDZ); // pc
  mpfr_set_d(c2mp_temp28, 8.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp30, NMAX, MPFR_RNDZ); // NMAX

  // operations
  mpfr_neg(c2mp_temp29, c2mp_temp30, MPFR_RNDZ); // c2mp_temp29 = -c2mp_temp30
  mpfr_mul(c2mp_temp26, c2mp_temp28, c2mp_temp27, MPFR_RNDZ); // c2mp_temp26 = c2mp_temp28 * c2mp_temp27
  mpfr_pow(c2mp_temp23, c2mp_temp30, c2mp_temp24, MPFR_RNDZ); // c2mp_temp23 = pow(c2mp_temp30, c2mp_temp24)
  mpfr_mul(c2mp_temp22, c2mp_temp25, c2mp_temp23, MPFR_RNDZ); // c2mp_temp22 = c2mp_temp25 * c2mp_temp23
  mpfr_sub(c2mp_temp21, c2mp_temp26, c2mp_temp22, MPFR_RNDZ); // c2mp_temp21 = c2mp_temp26 - c2mp_temp22
  mpfr_pow(c2mp_temp18, c2mp_temp30, c2mp_temp19, MPFR_RNDZ); // c2mp_temp18 = pow(c2mp_temp30, c2mp_temp19)
  ...
  mpfr_pow(c2mp_temp8, c2mp_temp30, c2mp_temp9, MPFR_RNDZ); // c2mp_temp8 = pow(c2mp_temp30, c2mp_temp9)
  mpfr_mul(c2mp_temp7, c2mp_temp10, c2mp_temp8, MPFR_RNDZ); // c2mp_temp7 = c2mp_temp10 * c2mp_temp8
  ...
  mpfr_clear(c2mp_temp25);
  mpfr_clear(c2mp_temp26);
  mpfr_clear(c2mp_temp27);
  mpfr_clear(c2mp_temp28);
