...
int main(void)
{
  ...
  mpfr_set_d(c2mp_temp14, 1.000000, MPFR_RNDZ);
  mpfr_set_d(c2mp_temp15, x, MPFR_RNDZ); // x

  // operations
  mpfr_mul(c2mp_temp13, c2mp_temp15, c2mp_temp14, MPFR_RNDZ); // c2mp_temp13 = c2mp_temp15 * c2mp_temp14
